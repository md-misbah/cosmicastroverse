...
import Author from "../images/meSq.jpeg"
            ...
            <div className="footerRes w-11/12 relative right sm:ml-0 md:ml-0 lg:ml-8 mt-8">
              ...
              <div className="authorWrap glassEf p-4">
                ...
                <div className="authorTxt text-white mt-4">
                  <h1 className=""><span className='text-md font-bold'>Name:</span> Md Misbah </h1>
                  <h1><span className='text-md font-bold'>Institute:</span><span> BAF Shaheen College Dhaka</span> </h1>
                  <div className="icoH font-bold mt-3 text-center">
                    Find Me On Social Media :
                  </div>
                  <div className="authorIcon flex justify-around mt-4 mb-4">
                    <a href="https://www.facebook.com/misba.h.ridita" target="_blank"><FaFacebook className='text-2xl' /></a>
                    <a href="https://www.instagram.com/misbah.hahahaha/" target="_blank"><RiInstagramFill className='text-2xl' /></a>
                    <a href="https://github.com/md-misbah" target="_blank"><FaGithub className='text-2xl' /></a>
                    <a href="https://mdmisbah-portfolio.netlify.app/" target="_blank"><IoGlobeSharp className='text-2xl' /></a>
